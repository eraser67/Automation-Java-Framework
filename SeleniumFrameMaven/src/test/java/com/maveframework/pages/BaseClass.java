...
public class BaseClass {
	...
	public void Setup() {
		...
		driver = BrowserFactory.StartApplication(driver, config.GetBrowser(), config.GetLowerURl());
...
//		logger.fail("Login Failed", MediaEntityBuilder.createScreenCaptureFromPath(Helper.ScreenShot(driver)).build());
			...
			logger.skip("Test Skip", MediaEntityBuilder.createScreenCaptureFromPath(Helper.ScreenShot(driver)).build());
